...
<Callout type="success" title="Listo: has completado el recorrido del curso">
Especificar, ajustar, comparar, diagnosticar, predecir y comunicar, este ciclo se repite (a veces varias veces) en cualquier análisis real de modelos mixtos. Vuelve a los módulos anteriores cuando lo necesites: son tu caja de herramientas.
</Callout>
